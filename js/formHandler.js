		    		...
		    		success: function() // Success
		 			{  
			   		...
			   		error: function() // Fail
			   		{
						...
						{
							$form.append("<div id='form-alert'><div class='alert alert-danger'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><strong>"+$form.data('fail-msg')+"</strong></div></div>");
						}	
			   		},
		   		});
			}
